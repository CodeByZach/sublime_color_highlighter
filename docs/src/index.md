...
_ColorHighlighter is a plugin for the Sublime Text, which unobtrusively previews color values by underlaying the selected hex codes in different styles, coloring text or gutter icons. Also, plugin adds color picker, color format converter to easily modify colors._

![Screenshot 1](images/screenshot-1.png)

![Screenshot 2](images/screenshot-2.png)

![Highlight Color](images/highlight-color.gif)
...
Just put the cursor (or multiple cursors) on the color code and select "Convert color to the next format" in context menu (or press ++ctrl+shift+comma++) or "Convert color to the previous format" in context menu (or press ++ctrl+shift+period++). This will convert colors under cursors between different supported color formats.
